...
if text:
    ...
    col2.markdown(f"<h3 style='text-align:center;'>occurences</h3>", unsafe_allow_html=True)
    col3.markdown(f"<h3 style='text-align:center;'>percentage</h3>", unsafe_allow_html=True)
